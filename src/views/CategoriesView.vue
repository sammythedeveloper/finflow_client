...
const expenseCount = computed(
  () =>
    categoryStore.categories.filter((category) => category.type === "Expense")
      .length
);

const incomeCount = computed(
  () =>
    categoryStore.categories.filter((category) => category.type === "Income")
      .length
);
...
<template>
  ...
  >
    <!-- Page header -->
    <section class="glass-card rounded-3xl p-6 md:p-7">
      <div
      ...
      >
        <div>
          ...
          >
            <span>
              <strong class="font-bold" style="color: var(--text-primary)">
                {{ totalCategories }}
              </strong>
              total
            </span>
            ...
            <span>
              <strong class="font-bold" style="color: var(--accent-bright)">
                {{ expenseCount }}
              </strong>
              expenses
            </span>
            ...
            <span>
              <strong class="font-bold" style="color: var(--income)">
                {{ incomeCount }}
              </strong>
              income
            </span>
    ...
    <Transition name="fade-up">
      <section
        ...
        class="glass-card relative z-20 rounded-3xl p-6"
      >
        <div class="mb-4">
    ...
    <!-- Category library -->
    <section v-else class="glass-card relative z-0 rounded-3xl p-6 md:p-7">
      <!-- Header / controls -->
      <div
      ...
      <!-- No search results -->
      <div v-if="displayedCategories.length === 0" class="py-12 text-center">
